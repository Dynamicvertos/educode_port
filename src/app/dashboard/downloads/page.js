...
const DOWNLOADS = {
  windows: {
    stable: [
      ...
      { id: 'windows-x64', label: 'Windows x64 (.exe)', href: 'https://github.com/theeducodeofficial-hub/EduCode-Releases/releases/download/v1.2.1/EduCode-Setup-Windows-V1.2.1.exe' },
